...
class JpboxSpider(scrapy.Spider):
    ...
    def parse(self, response):
        movies_links_list = response.xpath("//table[@class='tablesmall tablesmall5']//tr//h3/a/@href").getall()
    ...
    def parse_movie(self, response):
        ...
        item['release_date'] = response.xpath("//div[@class='bloc_infos_center tablesmall1b']//a/text()").get()
        item['entries'] = response.xpath("//table[@class='tablesmall tablesmall2']//tr[last()]//td[@class='col_poster_contenu_majeur']/text()").get()
        item['duration'] = response.xpath("((//table)[2]//h3//text())[5]").getall()
